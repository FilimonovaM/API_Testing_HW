...
import ex1.soap.YandexSpellerApi;
...
import static ex1.enums.ExceptionsEnum.ERROR_CAPITALIZATION;
import static ex1.enums.ExceptionsEnum.ERROR_REPEAT_WORD;
import static ex1.enums.ExceptionsEnum.ERROR_UNKNOWN_WORD;
...
public class YandexSpellerTestingRestVersion {

    @DataProvider(name = "word data update")
    public Object[][] newWords() {
    ...
    public void simpleAPITest(TestingValues data) {
        RestAssured
                ...
                .params(OPTIONS.param, DEFAULT.options)
