...
public class TestingValues {
    ...
    public static final TestingValues ALPHABET = new TestingValues("AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTt" +
            "UuVvWwXxYyZz", null);
    public static final TestingValues DATA_IGNORE_DIGITS = new TestingValues("Strorg", "Strong");
